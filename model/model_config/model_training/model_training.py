...
dataset_path = PROJECT_ROOT / "model" / "model_config" / "dataset_preparation" / "datasets" / "dataset.csv"
...
def create_model():
    def get_dataset() -> pd.DataFrame:
        if os.path.exists(dataset_path):
            ...
            from model.model_config.dataset_preparation.data_prep import create_dataset
